...
const toProxyImageUrl = (url) => `/api/products/image-proxy?url=${encodeURIComponent(String(url || '').trim())}`
            ...
            : trendingProducts.map((product) => (
              ...
              >
                <div className="relative overflow-hidden">
                  <img
                    src={product.images?.[0] ? toProxyImageUrl(product.images[0]) : `https://picsum.photos/seed/${product._id}/800/800`}
                    alt={product.name}
